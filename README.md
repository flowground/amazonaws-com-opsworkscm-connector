# ![LOGO](logo.png) AWS OpsWorks for Chef Automate MSP Connector

## Description

A generated MSP connector for the AWS OpsWorks for Chef Automate API (version 2016-11-01).
...
flowground :- Telekom iPaaS / amazonaws-com-opsworkscm-connector<br/>
